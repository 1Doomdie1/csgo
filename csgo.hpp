...
// 2022-05-10 21:15:59.322649600 UTC

namespace hazedumper {
constexpr ::std::int64_t timestamp = 1652217359;
namespace netvars {
...
constexpr ::std::ptrdiff_t dwForceAttack2 = 0x3203944;
...
constexpr ::std::ptrdiff_t find_hud_element = 0x277F5200;
